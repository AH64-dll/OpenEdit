...
>
> **Status:** **M0–M3 COMPLETE**; **smoke done / preview-chunks default-on / PR pending `gh auth`** on `feat/render-m0-m1-remotion-engine` (2026-08-03). Acceptances: [M0/M1](../specs/2026-08-03-m0-m1-acceptance.md) · [M2](../specs/2026-08-03-m2-acceptance.md) · [M3](../specs/2026-08-03-m3-acceptance.md) (manual MCP/host smoke recorded). Disable with `OPEN_EDIT_PREVIEW_CHUNKS=0`. Review Studio UI Tasks 11–13 skipped (MCP-first). M4 live MLT still deferred.
> **Date:** 2026-08-03
